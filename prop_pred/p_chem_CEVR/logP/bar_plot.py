...
plt.bar(
    ...
    first_bar,
    width,
    label="Without LC informations",
    hatch="/////",
    edgecolor="black",
    color="white",
)  # yerr=[0.061,0.056,0.058,0.080],capsize=6,ecolor='black')
plt.bar(
    ind + width,
    second_bar,
    width,
    label="With LC informations",
    edgecolor="black",
    color="black",
)  # yerr= [0.057,0.057,0.059,0.074],capsize=6,ecolor='black')
...
plt.bar(
    ...
    edgecolor="black",
    color="white",
)  # ,yerr=[0.058,0.045,0.056,0.051],capsize=6,ecolor='black')
plt.bar(
    ind + width,
    second_bar,
    width,
    ...
    edgecolor="black",
    color="black",
)  # ,yerr= [0.056,0.047,0.056,0.050],capsize=6,ecolor='black')
