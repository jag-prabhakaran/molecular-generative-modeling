...
def run_best_model(arg_1, arg_2):
    ...
    des_without_lc_feat_corr = des_without_lc.columns[
        des_without_lc.corrwith(des_without_lc["LogP"]) >= 0.90
    ][:-1]
    ...
    best_model = RandomForestRegressor(
        n_estimators=n_estimators_list[best_parameters_without_lc["n_estimators"]],
        max_depth=max_depth_list[best_parameters_without_lc["max_depth"]],
        min_samples_leaf=min_samples_leaf_list[
            best_parameters_without_lc["min_samples_leaf"]
        ],
        min_samples_split=min_samples_split_list[
            best_parameters_without_lc["min_samples_split"]
        ],
    ...
    tra_results = [
        "tra",
        mean_squared_error(data_tra_y, tra_pred),
    ...
    val_results = [
        "val",
        mean_squared_error(data_val_y, val_pred),
    ...
    tes_results = [
        "tes",
        mean_squared_error(data_tes_y, tes_pred),
...
def run_best_model(arg_1, arg_2):
    ...
    for split in range(1, splits + 1):
        ...
        validate, test = train_test_split(
            rest, train_size=0.5, shuffle=True, random_state=seed
        )
    ...
    all_set_df = pd.DataFrame(
        all_set, columns=["split", "set", "mse", "rmse", "mae", "r2"]
    )
    data_res = [
        [
            "MSE",
            str(format(all_set_df[all_set_df["set"] == "tra"]["mse"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tra"]["mse"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "val"]["mse"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "val"]["mse"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "tes"]["mse"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tes"]["mse"].std(), ".3f")),
        ],
        [
            "RMSE",
            str(format(all_set_df[all_set_df["set"] == "tra"]["rmse"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tra"]["rmse"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "val"]["rmse"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "val"]["rmse"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "tes"]["rmse"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tes"]["rmse"].std(), ".3f")),
        ],
        [
            "MAE",
            str(format(all_set_df[all_set_df["set"] == "tra"]["mae"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tra"]["mae"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "val"]["mae"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "val"]["mae"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "tes"]["mae"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tes"]["mae"].std(), ".3f")),
        ],
        [
            "R2",
            str(format(all_set_df[all_set_df["set"] == "tra"]["r2"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tra"]["r2"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "val"]["r2"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "val"]["r2"].std(), ".3f")),
            str(format(all_set_df[all_set_df["set"] == "tes"]["r2"].mean(), ".3f"))
            + "+/-"
            + str(format(all_set_df[all_set_df["set"] == "tes"]["r2"].std(), ".3f")),
        ],
    ]
...
def run_best_model(arg_1, arg_2):
    ...
    des_with_lc_feat_corr = des_with_lc.columns[
        des_with_lc.corrwith(des_with_lc["LogP"]) >= 0.90
    ][:-1]
    ...
    best_model = RandomForestRegressor(
        n_estimators=n_estimators_list[best_parameters_with_lc["n_estimators"]],
        max_depth=max_depth_list[best_parameters_with_lc["max_depth"]],
        min_samples_leaf=min_samples_leaf_list[
            best_parameters_with_lc["min_samples_leaf"]
        ],
        min_samples_split=min_samples_split_list[
            best_parameters_with_lc["min_samples_split"]
        ],
