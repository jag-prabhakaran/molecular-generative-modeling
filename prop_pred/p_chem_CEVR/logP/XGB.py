...
def run_best_model(arg_1, arg_2):
    ...
    best_model = XGBRegressor(
        n_estimators=n_estimators_ls[best_parameters_without_lc["n_estimators"]],
        max_depth=max_depth_ls[best_parameters_without_lc["max_depth"]],
        min_child_weight=min_child_weight_ls[
            best_parameters_without_lc["min_child_weight"]
        ],
...
def run_best_model(arg_1, arg_2):
    ...
    best_model = XGBRegressor(
        ...
        min_child_weight=min_child_weight_ls[
            best_parameters_with_lc["min_child_weight"]
        ],
