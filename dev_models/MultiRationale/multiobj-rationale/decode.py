...
parser.add_argument("--rationale", default="rationale.txt")
parser.add_argument("--atom_vocab", default=common_atom_vocab)
parser.add_argument("--model", default="ckpt/gsk3_jnk3_qed_sa/model.final")
...
def decode(input, n_mol):
    testdata = [input]
    dataset = SubgraphDataset(testdata, args.atom_vocab, args.batch_size, n_mol)
